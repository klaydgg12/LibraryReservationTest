...
function EquipmentManagement() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Equipment added: ${equipmentName}`);
    setEquipmentName('');
    setQuantity('');
  };
    ...
    <div style={styles.container}>
      ...
      <main style={styles.main}>
        <div style={styles.imageContainer}>
          <div style={styles.overlay}>Equipment Management</div>
          <div style={styles.subText}>Manage library equipment here.</div>
          <form style={styles.formContainer} onSubmit={handleSubmit}>
            <label style={styles.label}>Equipment Name:</label>
            <input style={styles.input} value={equipmentName} onChange={e => setEquipmentName(e.target.value)} required />
